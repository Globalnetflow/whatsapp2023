...
!(function (t, e) {
    ...
    function $e(t, e, i) {
        ...
        var n,
            ...
            h = { x: 0, y: 0 };
        return (o || (!o && !i)) && (('body' !== Wt(e) || Ee(a)) && (c = (n = e) !== Bt(n) && zt(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } : we(n)), zt(e) ? (((h = Gt(e, !0)).x += e.clientLeft), (h.y += e.clientTop)) : a && (h.x = Ae(a))), { x: l.left + c.scrollLeft - h.x, y: l.top + c.scrollTop - h.y, width: l.width, height: l.height };
    }
    function We(t) {
        var e = new Map(),
            i = new Set(),
    ...
    class hi extends z {
        ...
        _getPopperConfig() {
            ...
            return (this._inNavbar || 'static' === this._config.display) && (B.setDataAttribute(this._menu, 'popper', 'static'), (t.modifiers = [{ name: 'applyStyles', enabled: !1 }])), { ...t, ...('function' == typeof this._config.popperConfig ? this._config.popperConfig(t) : this._config.popperConfig) };
        }
